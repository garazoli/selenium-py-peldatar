text_main = '''The Old Sea-dog at the Admiral Benbow
...
list_str = text_main.split()

freq = [list_str.count(w) for w in list_str]
print(dict(zip(list_str, freq)))

# Ennyi sikerült... Google-ről vadászva, hátha ér fél pontot.